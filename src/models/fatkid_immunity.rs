...
pub async fn get_player_immunity_info(
    db: &Database,
    user_id: UI,
    guild_id: GI,
) -> Result<PlayerImmunityInfo> {
...
pub async fn get_immunity_level(
    db: &Database,
    user_id: UI,
    guild_id: GI,
) -> Result<u32> {
